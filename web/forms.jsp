...
<head>
	...
	<title>Форма записи к врачу</title>
...
<div class="wrapper">
			...
			<div class="container-fluid">
				...
				<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
					...
					<li class="nav-item dropdown">
						<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="assets/img/profile.jpg" alt="user-img" width="36" class="img-circle"><span ><%request.getParameter("name");%></span></span> </a>
	...
	<div class="sidebar">
		<div class="scrollbar-inner sidebar-wrapper">
			...
			<li class="nav-item">
				<form action="/form?name=<%out.println(session.getAttribute("name"));%>" method="post">
					<button>
						<i class="la la-th"></i>
						<p>Запись к врачу</p>
					</button>
	...
	<div class="main-panel">
		<div class="content">
			<div class="container-fluid">
				<h4 class="page-title">Форма записи</h4>
				<div class="row">
					<div class="col-md-6">
						<div class="card">
